...
require_once "config.php";
    ...
    $questionString = "Epilepsy continues to be a misunderstood, stigmatizing condition and it does not have to be! Join EpiCentral at JEA to help End the Stigma. Text SIGNUP to join!";
    ...
    $sql = "SELECT * FROM users WHERE Status=0"; // select interested, uncontacted people
    ...
    $sql = "UPDATE users SET Status=1 WHERE PhoneNumber IN (" . implode(",", $ToNumbers) . ");";
